...
#time ./tools/train_faster_rcnn_alt_opt.py --gpu ${GPU_ID} \
#  --net_name ${NET} \
#  --weights output/faster_rcnn_alt_opt/celeba_trainval/ZF_faster_rcnn_final.caffemodel \
#  --imdb ${TRAIN_IMDB} \
#  --cfg experiments/cfgs/faster_rcnn_alt_opt.yml \
#  ${EXTRA_ARGS}
...
NET_FINAL="output/faster_rcnn_alt_opt/celeba_trainval/zf_fast_rcnn_stage2_iter_100000.caffemodel"
set -x
